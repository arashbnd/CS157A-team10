...
<html>
<head>
    <title>Dry Goods And Pasta</title>
    <meta charset="UTF-8">
...
<table border="1">
    ...
    <%
        ...
        ResultSet rs = stmt.executeQuery("Select ProductID, PName, Photo, Description, Price from products where CategoryID = 6");
        while(rs.next()){
    ...
    <tr>
        ...
        <td><form action="DryGoodsAndPasta.jsp">
